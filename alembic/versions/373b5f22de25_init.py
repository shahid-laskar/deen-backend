...
Revision ID: 373b5f22de25
Revises: 
Create Date: 2026-04-11 01:14:02.356783
...
def upgrade() -> None:
    ...
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('tajweed_errors', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('notes', sa.Text(), nullable=True),
    sa.Column('rating', sa.Integer(), nullable=True),
    sa.Column('exercises_log', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('completed', sa.Boolean(), nullable=False),
