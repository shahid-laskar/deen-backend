...
# Patch: add ASSEMBLYAI_API_KEY to existing settings
# Since Settings is already defined, we monkey-patch via __init_subclass__
# The proper way is to add it directly — done via sed below
